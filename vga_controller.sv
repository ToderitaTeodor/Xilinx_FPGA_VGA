...
// Enable signal to start vertical counter
wire enable = (h_counter == H_TOTAL - 1);

// Generate sync pulses during their specific timing windows (Active-Low)
...
// High only when counters are within the visible screen area
